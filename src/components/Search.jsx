...
const Search = () => {
    ...
    const showDetail = (_movieID) => {
        setMode('detail');
        console.log('detail')
        setDetailInfo({});
        axios.get(`https://api.themoviedb.org/3/movie/${_movieID}?api_key=${apiKey}&language=ko-KR`)
            .then((response) => {
        ...
        axios.get(`https://api.themoviedb.org/3/movie/${_movieID}/credits?api_key=${apiKey}&language=ko-KR`)
            .then((response) => {
...
const Search = () => {
    ...
    const [detailInfo, setDetailInfo] = useState({});
    const [actors, setActors] = useState([]);
    const [selectedMovieID, setSelectedMovieID] = useState(null); // Add selectedMovieID state
    ...
    const showDetail = (movieID) => {
        setMode('detail');
        setSelectedMovieID(movieID); // Update selectedMovieID when a movie is clicked
